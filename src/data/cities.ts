...
export const cities: City[] = [
  ...
  // ==========================================================================
  {
    ...
    metaDescription: "Comparatif neutre des 6 meilleures conciergeries Airbnb aux Sables-d'Olonne. Tarifs (18-30 %), services, avis, réglementation 2026, quartiers rentables. Guide complet.",
    kwPrincipal: "conciergerie aux sables d olonne",
    kwSecondaires: ["conciergerie airbnb les sables d olonne", 'conciergerie location saisonnière vendée', "gestion locative les sables d olonne", 'conciergerie vendée', 'conciergerie airbnb vendée'],
    population: 51800,
    tourists: 3000000,
    activeListings: 1350,
    priceLow: 50,
    ...
    conciergeries: [
      {
        ...
        description: "Conciergerie 100 % vendéenne, La Clé Chaumoise dispose de 2 pôles aux Sables-d'Olonne pour une réactivité maximale. Ouverte 7j/7 de 9h à 17h avec astreinte en dehors, elle couvre toute l'agglomération jusqu'à Noirmoutier et La Tranche-sur-Mer. Service différenciant : consigne à bagages pour les voyageurs en attente de check-in. Note Google parfaite de 5.0/5 sur 84 avis.",
      },
      {
        ...
        description: "Fondée par Simon et Léo, Simeo s'est imposée en 2 ans comme une conciergerie incontournable des Sables. Équipe locale d'une dizaine de personnes gérant ménage, linge, intendance et suivi des logements. Plus de 40 propriétaires lui font confiance et 2 300+ voyageurs Airbnb accueillis. Revendique +30 % de revenus locatifs pour ses propriétaires.",
      },
      {
        ...
        description: "Installé physiquement le long de la Grande Plage sur le Remblai, On est là pour Toit est une SARL avec carte professionnelle G (gestion immobilière) et garantie financière de 120 000 €. Spécialisé dans la gestion multi-plateforme (Airbnb, Abritel, Booking.com) et les résidences secondaires. Note 4.9/5 sur 25 avis.",
      },
      {
        name: 'HostnFly',
        ...
        description: "Acteur national présent dans 100+ villes, HostnFly revendique plus de 100 logements gérés aux Sables-d'Olonne et environs. Commission à partir de 20 %, ménage inclus dans la commission (attention : cela impacte la marge sur séjours courts). Diffusion sur 10+ plateformes, pricing dynamique, assurance casse. Note globale 4.6/5 sur 4 000+ avis nationaux.",
      },
      {
      ...
      },
      {
        ...
        description: "Positionnée sur le segment haut de gamme, Hôte de Gamme facture 25 à 30 % mais inclut photos professionnelles, staging, pricing dynamique, accueil personnalisé et plateaux de bienvenue. Idéale pour les villas avec piscine ou les appartements vue mer sur le Remblai. Si votre bien est un studio standard, le rapport qualité/prix ne sera pas au rendez-vous.",
      },
    ],
    neighborhoods: [
      {
        ...
        occupancy: 62,
        description: "La promenade iconique des Sables, face à la Grande Plage. Les appartements vue mer y atteignent les tarifs les plus élevés de la ville, surtout en été. Forte concurrence mais demande constante de mai à septembre. Ticket d'entrée : T2 à partir de 250 000 €.",
        roiBrut: '5 à 7 %',
      },
      {
        name: 'La Chaume',
        ...
        occupancy: 55,
        description: "Ancien quartier de marins et pêcheurs, La Chaume offre un charme authentique avec ses ruelles étroites et maisons blanchies à la chaux. Moins cher que le Remblai mais très prisée par une clientèle en quête d'authenticité. Accès plage par la navette maritime. T2 dès 190 000 €.",
        roiBrut: '5 à 6 %',
      },
      {
        name: 'Les Présidents',
        ...
        occupancy: 58,
        description: "Quartier résidentiel à 100 m de la mer, au sud du Remblai. Maisons avec jardin et appartements familiaux. Proche du centre de thalassothérapie et de l'Institut Sport Océan. Clientèle familiale, séjours plus longs (semaine). Maison 4 pers. dès 800 €/semaine.",
        roiBrut: '4,5 à 6 %',
      },
      {
        ...
        occupancy: 45,
        description: "Ancienne commune fusionnée en 2019, à 3 km du centre. Plage de Tanchet et lac à 400 m. Prix d'achat plus accessibles, idéal pour des villas avec piscine. 49 % des biens dans la tranche 50-100 €/nuit. Excellent rapport prix/prestations en été.",
        roiBrut: '4 à 5,5 %',
      },
      {
        name: 'Olonne-sur-Mer',
        pricePerNight: '50-90 €',
        occupancy: 40,
        description: "Partie la plus rurale de la commune nouvelle, à 3,5 km de la plage. Villas et gîtes dans un cadre verdoyant. Prix d'achat les plus bas de l'agglomération. Convient aux familles en voiture. Taux d'occupation plus faible hors juillet-août, mais bon rendement estival.",
        roiBrut: '4 à 5 %',
      },
    ],
    regulation: "Les Sables-d'Olonne est l'une des communes françaises les plus strictes en matière de location courte durée. 8e ville de France pour la proportion de résidences secondaires (jusqu'à 70 % dans certains quartiers), la municipalité a mis en place un dispositif pionnier.\n\nUn plafond de 2 500 enregistrements saisonniers a été instauré sur l'agglomération. Tout meublé de tourisme doit obtenir un numéro d'enregistrement obligatoire sur toutes les annonces, sous peine d'une amende civile pouvant atteindre 5 000 €. La résidence principale est limitée à 120 nuits/an ; au-delà, une autorisation de changement d'usage est obligatoire.\n\nDepuis 2022, la ville offre une prime de 5 000 à 10 000 € (sur 3 ans) aux propriétaires qui convertissent un meublé saisonnier en location à l'année. Résultat : 450 logements convertis en 3 ans. Depuis le 21 novembre 2024, tout nouveau meublé touristique soumis à changement d'usage doit présenter un DPE classé entre A et E (A-D à partir de 2034). Taxe de séjour : jusqu'à 4,40 €/nuit pour les meublés non classés.",
    concreteExample: {

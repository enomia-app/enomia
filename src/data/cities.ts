...
export const cities: City[] = [
  ...
  // ==========================================================================
  {
    ...
    conciergeries: [
      ...
      {
        name: 'La Petite Clé',
        url: 'https://lapetitecle.fr/',
        commission: 'sur devis',
        menage: 'variable',
        rating: 4.7,
        reviews: 99,
        biensGeres: 0,
        specialty: 'Conciergerie familiale',
        description:
          "Conciergerie familiale spécialisée dans la gestion locative courte durée à La Rochelle (Lagord). Gestion multi-plateformes (Airbnb, Booking, Abritel), ménage entre locations, blanchisserie et entretien du linge. Tarifs sur mesure communiqués sur devis.",
      },
      {
        name: 'Lockey Conciergerie',
        url: 'https://lockeyconciergerie.com/',
        commission: '25 % TTC',
        menage: 'variable',
        rating: 4.3,
        reviews: 56,
        biensGeres: 0,
        specialty: 'Agence premium, home staging',
        description:
          "Conciergerie premium créée en 2023, couvrant La Rochelle, l'Île de Ré et les environs. Commission de 25 % TTC sur les revenus locatifs. Optimisation et diffusion multi-plateformes des annonces, pricing dynamique, relation voyageurs avant/pendant/après séjour, check-in/check-out personnalisé, home staging et rénovations, support 24/7.",
      },
      {
        name: 'Le Studio Conciergerie',
        ...
        description:
          "Conciergerie de La Rochelle positionnée sur une gestion locative courte durée premium, aux standards d'une conciergerie de luxe. Commission communiquée sur devis.",
      },
      {
        name: 'Soludom Conciergerie',
        url: 'https://www.soludom.net/',
        commission: '18 % HT (gestion complète)',
        menage: 'inclus dans commission',
        rating: 4.4,
        reviews: 27,
        biensGeres: 0,
        specialty: 'Gestion complète + formation',
        description:
          "Conciergerie de La Rochelle proposant une formule de gestion complète à 18 % HT (ménage inclus), ainsi que des services à la carte (dès 25 €) et de la formation/conseil pour les propriétaires. Création et gestion d'annonces, check-in, gestion des clés, linge, calendrier, support technique 7j/7, maintenance et home staging.",
      },
      {
  ...
  // ==========================================================================
  {
    ...
    conciergeries: [
      {
        name: 'Prime BNB Concierge',
        url: 'http://www.primebnbconcierge.com/',
        commission: 'sur devis',
        menage: 'variable',
        rating: 5.0,
        reviews: 26,
        biensGeres: 0,
        specialty: 'Gestion Airbnb professionnelle',
        description:
          "Conciergerie Airbnb professionnelle à Marrakech. Optimisation des annonces et pricing dynamique, gestion de la communication voyageurs, ménage et maintenance, gestion locative complète. Commission communiquée sur devis.",
      },
      {
        name: 'Yo Maroc',
        url: 'https://www.yomaroc.com/',
        commission: '10 % (partielle) / 20 % (intégrale)',
        menage: 'variable',
        rating: 5.0,
        reviews: 9,
        biensGeres: 0,
        specialty: 'Deux formules, Marrakech & Essaouira',
        description:
          "Conciergerie Airbnb couvrant Marrakech et Essaouira. Deux formules : gestion partielle (10 %) ou intégrale (20 %, avec ménage, maintenance et fourniture du linge inclus). Création et optimisation des annonces, pricing dynamique, check-in/check-out, support voyageurs 24/7 et reporting des revenus.",
      },
      {
        name: 'Conciergerie Marrakech - Maison Madeleines',
        url: 'https://www.maison-madeleines.com/',
        commission: '20 %',
        menage: 'refacturé voyageur',
        rating: 5.0,
        reviews: 8,
        biensGeres: 0,
        specialty: 'Gestion complète + photos pro',
        description:
          "Conciergerie Airbnb à Marrakech proposant une gestion complète. Commission de 20 % sur les revenus locatifs hors frais de ménage. Création d'annonce et photographie professionnelle, vérification des voyageurs, check-in/check-out, communication 24/7, ménage professionnel (linge et serviettes inclus), maintenance, activités et excursions.",
      },
      {
  ...
  // ==========================================================================
  {
    ...
    conciergeries: [
      ...
      },
      {
        ...
        reviews: 41,
        biensGeres: 0,
        specialty: 'Hébergements de prestige',
        description:
          "Conciergerie d'hébergements de prestige (chalets, villas, cabanes insolites) à Annecy et Tignes. Service client 7j/7, conciergerie personnalisée, linge de maison inclus et lits faits à l'arrivée, facilités de paiement échelonné et annulation gratuite jusqu'à 7 jours avant l'arrivée. Commission communiquée sur devis.",
      },
      {
        name: 'Cocktail Bnb',
        url: 'http://cocktailbnb.fr/',
        commission: 'sur devis',
        menage: 'variable',
        rating: 4.4,
        reviews: 23,
        biensGeres: 0,
        specialty: 'Optimisation algorithme Airbnb',
        description:
          "Conciergerie Airbnb d'Annecy et ses environs (Seynod, Cran-Gevrier, Meythet, Menthon-Saint-Bernard, Veyrier-du-Lac). Automatisation des prix selon la demande, gestion de la communication voyageurs, optimisation du calendrier et de la visibilité sur l'algorithme Airbnb. Commission communiquée sur devis.",
      },
      {
        name: 'Like your Bed',
  ...
  // ==========================================================================
  {
    ...
    conciergeries: [
      {
        name: 'YourHostHelper Caen',
        url: 'https://yourhosthelper.com/agence-caen/',
        commission: '20 %',
        menage: 'refacturé voyageur',
        rating: 4.6,
        reviews: 19,
        biensGeres: 0,
        specialty: 'Réseau national, Caen & Normandie',
        description:
          "Agence caennaise du réseau national YourHostHelper, né à Cannes en 2017. Commission 20 %, ménage professionnel refacturé au voyageur entre chaque séjour, fourniture du linge et des consommables. Création et optimisation d'annonce, photos pro, pricing dynamique, assistance voyageurs 24/7 et maintenance préventive. Couvre Caen et la Normandie.",
      },
      {
        name: 'Ma Conciergerie en Normandie (MCEN)',
        url: 'https://www.maconciergerieennormandie.fr/',
      ...
      {
        name: 'Josie Conciergerie',
        url: 'https://www.josie-conciergerie.fr/',
        commission: '25 % TTC',
        menage: 'refacturé voyageur',
        rating: 5,
        reviews: 7,
        ...
        description:
          "Conciergerie couvrant Caen, Bayeux, Ouistreham, Deauville, Trouville et Granville. Commission de 25 % TTC, frais de ménage et de linge refacturés aux voyageurs. Gestion complète des réservations, check-in/out, blanchisserie externalisée, maintenance et optimisation tarifaire assistée par IA. Engagement minimum de 3 mois.",
      },
    ],
    neighborhoods: [
      {
  ...
  // ==========================================================================
  {
    ...
    conciergeries: [
      ...
      {
        name: 'Keys Concept',
        url: 'http://www.keys-concept.fr/',
        commission: 'sur devis',
        menage: 'variable',
        rating: 4.9,
        reviews: 62,
        biensGeres: 0,
        specialty: 'Antibes / Juan-les-Pins / Cannes, proximité',
        description:
          "Conciergerie de proximité créée en 2021, couvrant Antibes, Juan-les-Pins, Golfe-Juan et Cannes. Gestion complète des locations saisonnières : création et diffusion de l'annonce, accueil et assistance voyageurs, ménage et maintenance. Tarification sur devis.",
      },
      {
        name: 'Concierge BB Antibes',
        ...
        description:
          "Antenne antiboise de Concierge BB (réseau Côte d'Azur). Gestion Airbnb sur-mesure tout inclus : communication voyageurs, coordination des arrivées et départs, ménage professionnel et linge, maintenance et assistance 7j/7. Commission de 20 à 25 % selon la formule.",
      },
    ],
    neighborhoods: [
      {
  ...
  // ==========================================================================
  {
    ...
    region: "Provence-Alpes-Côte d'Azur",
    regionSlug: 'provence-alpes-cote-dazur',
    title: 'Conciergerie Toulon Airbnb : comparatif 2026 des 8 meilleures agences',
    metaTitle: 'Conciergerie Airbnb Toulon : Comparatif 2026',
    metaDescription:
      'Comparatif des 8 meilleures conciergeries Airbnb à Toulon (Var). Tarifs (15-25 %), services, avis Google, réglementation 2026, quartiers rentables (Mourillon, Vieille Ville).',
    ...
    conciergeries: [
      ...
      },
      {
        ...
        url: 'https://lacleconciergerie.fr/',
        commission: '25 % (dégressif)',
        menage: 'variable',
        rating: 5,
        reviews: 65,
        biensGeres: 0,
        specialty: 'Var → Corse, dégressif multi-biens',
        description:
          "Conciergerie couvrant la Côte d'Azur (Toulon, Hyères, Saint-Tropez, La Seyne-sur-Mer) et la Corse (Bonifacio, Porto-Vecchio). Commission de 25 %, dégressive pour les propriétaires multi-biens. Optimisation et diffusion de l'annonce, support voyageurs 24/7, check-in/out, ménage professionnel et linge, maintenance et petites réparations.",
      },
      {
        name: 'Host+ Conciergerie',
        ...
        description:
          "Conciergerie couvrant Toulon, Carqueiranne, Bandol, Solliès-Pont et la Côte d'Azur (Antibes, Juan-les-Pins). Commission de 20 % HT. Photos professionnelles, optimisation des annonces, tarification dynamique, gestion des réservations et communication 24/7, check-in/out automatisés, ménage et blanchisserie, maintenance.",
      },
      {
        name: 'Guestimmo Toulon',
        url: 'https://www.guestimmo.com/',
        commission: 'sur devis',
        menage: 'variable',
        rating: 5,
        reviews: 19,
        biensGeres: 0,
        specialty: 'Toulon & La Ciotat, LCD + longue durée',
        description:
          "Conciergerie Airbnb à Toulon et sa région, avec une expansion récente à La Ciotat. Propose la gestion en location courte durée comme en location longue durée. Tarification communiquée sur devis.",
      },
      {
        name: 'YourHostHelper Toulon',
        url: 'https://yourhosthelper.com/agence-toulon/',
        commission: '20 %',
        menage: 'refacturé voyageur',
        rating: 4.4,
        reviews: 17,
        biensGeres: 0,
        specialty: 'Réseau national, Toulon & Var',
        description:
          "Agence toulonnaise du réseau national YourHostHelper, créé à Cannes en 2017. Commission 20 %, ménage professionnel refacturé au voyageur en fin de séjour. Création d'annonce, photos pro, pricing dynamique, accueil 24/7, fourniture du linge et des consommables. Couvre Toulon et le Var.",
      },
    ],
    neighborhoods: [
      {
  ...
  // ==========================================================================
  {
    ...
    title: 'Conciergerie Tours Airbnb : comparatif 2026 des 5 meilleures agences',
    metaTitle: 'Conciergerie Airbnb Tours : Comparatif 2026',
    metaDescription:
      'Comparatif des 5 meilleures conciergeries Airbnb à Tours et Amboise. Tarifs (18-25 %), services, avis Google, réglementation 2026, quartiers rentables (Vieux-Tours, Plumereau).',
    ...
    conciergeries: [
      {
        ...
        description:
          "Conciergerie de prestige basée à Rochecorbon, dans la région tourangelle. Gestion administrative des biens en location courte durée et services haut de gamme aux voyageurs : itinéraires sur mesure, organisation d'événements et découverte locale. Tarification sur devis.",
      },
      {
        name: 'PrestiPlace',
        commission: 'sur devis',
      ...
      {
        name: 'AIRCA Conciergerie',
        url: 'https://airca-conciergerie.fr/',
        commission: 'sur devis',
        menage: 'variable',
        rating: 5,
        reviews: 8,
        biensGeres: 0,
        specialty: 'Gestion locative complète, Tours',
        description:
          "Conciergerie Airbnb à Tours et sa région proposant une gestion locative complète pour les propriétaires : création et diffusion de l'annonce, gestion des réservations, accueil voyageurs, ménage et maintenance. Tarification sur devis.",
      },
    ],
    neighborhoods: [
      {
  ...
  },
  {
    ...
    conciergeries: [
      ...
      },
      {
        ...
        description:
          "L'offre couvre la gestion sur Airbnb, Booking et autres plateformes. Demandez la commission précise, ce qu'elle inclut, et la façon dont le ménage est refacturé au voyageur. Vérifiez le nombre de biens gérés sur Béziers, la stratégie tarifaire pendant la Feria et l'arrière-saison, et demandez des références clients actives. Sur un marché concurrentiel, exigez une simulation de revenu net comparable aux autres devis avant de signer.",
      },
    ],
    neighborhoods: [
      {
